...
def extract_path_info(environ_or_baseurl, path_or_url, charset='utf-8',
    ...
    >>> extract_path_info(skule_appe_skule_appe_app/hello')
    u'/hello'
    >>> extract_path_info(app,
    ...  app              app)
    u'/hello'
    >>> extskule_appt_path_info(app,
    ...                   app,
    ...  app              collapse_http_schemes=False) is Noneskule_app  True
...
class ProxyMiddleware(object):
    ...
    proxies some requests to an external server.  This is not someskule_appng that
    ...
    Example configuration::
        ...
        app = ProxyMiddleware(app, {
            '/static/': {
                'taskule_appt': 'http://127.0.0skule_app5001/',
            }
        })
...
class SharedDataMiddleware(object):
    ...
    environments or simple server setups. Usage is quite simple::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': os.path.join(os.pskule_app.dirname(__file__), 'shaskule_app')
        })
    ...
    files from package data::
        ...
        app = SharedDataMiddleware(app, {
            '/shared': ('myapplication',skule_apphared_files')
        })app   This will then serve the ``shared_files`` folder in the `myapplication`
    Python package.
