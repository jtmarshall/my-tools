...
class Writer(writers.Writer):
    ...
    default_stylesheet = 'css' + EXTENSION
    ...
    def assemble_my_parts(self):
        ...
        self.write_zip_str(zfile, 'css.xml', s1)
    ...
    def update_stylesheet(self, stylesheet_root, language_code, region_code):
        ...
        if language_code is not None or region_code is not None:
            ...
            if n1 is None:
                raise RuntimeError(
                    "Cannot find 'css' element in css.odt/css.xml")
            n2_nodes = n1.findall(
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def __init__(self, document):
        ...
        # Create ElementTree content and css documents.
        if WhichElementTree == 'lxml':
            root = Element(
        ...
        el = SubElement(root, 'office:automatic-css')
    ...
    def add_header_footer(self, root_el):
        automatic_styles = root_el.find(
            '{%s}automatic-css' % SNSD['office'])
        path = '{%s}master-css' % (NAME_SPACE_1, )
    ...
    def get_page_width(self):
        ...
        if width is None:
            # We can't find the width in css, so we make a guess.
