...
class AuditCSV extends React.Component {

    pathName = location.pathname === "/" ? "" : location.pathname;
    csvEndpoint = location.origin + this.pathName + "/api/auditCSV";
    ...
    // Change audit type on user selection
    handleChange = event => {
        this.setState({
    ...
    uploadRequest = (data) => {
        ...
        // scope handle error func
        let handleErr = this.handleErr;
    ...
    handleUpload = () => {
        ...
        if (this.state.selectedFile.size > 5000000 || this.state.auditType === 'status') {
            // get s3 signed url to upload file into s3 first
        ...
        return (
            <div style={{width: '460px'}}>
                <h4 className="d-flex justify-content-between align-items-center mb-3">
                    <span className="text-muted" style={{display: "block", margin: "auto"}}>Audit Upload</span>
                </h4>

                {/*<div className="form-group" style={{textAlign: 'center'}}>*/}
                {/*    <label htmlFor="auditSelect">Type:</label>*/}
                ...
                <p className="loading">
                    <code>It looks like your upload is quite <b>large</b>,<br/>consulting the cloud</code>
